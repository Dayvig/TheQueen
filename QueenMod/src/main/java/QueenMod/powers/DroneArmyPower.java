...
public class DroneArmyPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = QueenMod.makeID("DroneArmyPower");
    ...
    public DroneArmyPower (final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void onAfterUseCard(final AbstractCard card, final UseCardAction action) {
        if (card.cardID.equals(Drone.ID) ||
    ...
    public AbstractPower makeCopy() {
        return new DroneArmyPower(owner, source, amount);
    }
}
