...
public class AttackNextTurnPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public AttackNextTurnPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void atStartOfTurn() {
        ...
        AbstractDungeon.actionManager.addToBottom(new AddToTopOfDrawPileAction(AbstractDungeon.player.drawPile, this.amount, AbstractCard.CardType.ATTACK));
        AbstractDungeon.actionManager.addToBottom(new RemoveSpecificPowerAction(this.owner, this.owner, this.POWER_ID));
    }
